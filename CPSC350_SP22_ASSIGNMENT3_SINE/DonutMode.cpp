...
DonutMode::DonutMode(int rows, int columns, float density) : super(rows,columns,density){}

// Overloaded constructor, uses base class instantiation for mapped text file configuration
DonutMode::DonutMode(ifstream &inFS) : super(inFS){}
...
variable x and y are used to translate out of bound indecies into valid arguments if needed
*/
void DonutMode::calcNextGen(){
  int neighbors;
